...
const DISTRICTS_METADATA: { [key: string]: DistrictMetadata } = {
  Srikakulam: {
    name: "Srikakulam",
    coords: [18.3186, 83.8967],
    code: "SKLM",
    zone: "North Coast AP",
    basin: "Nagavali & Vamsadhara Basins",
    soil: "Red Sandy Clay",
    coeff: 0.42,
    baseFlood: 40,
    baseHeat: 45,
  ...
  Eluru: {
    name: "Eluru",
    coords: [16.7107, 81.1011],
    code: "ELR",
    zone: "Krishna-Godavari Delta",
    basin: "Tammileru Basin",
    soil: "Alluvial Loam",
    coeff: 0.50,
    baseFlood: 58,
    baseHeat: 54,
  ...
  Nellore: {
    ...
    basin: "Pennar Basin",
    soil: "Sandy Coastal",
    coeff: 0.50, // Updated to 0.50 to align with backend specs & tests
    baseFlood: 45,
    baseHeat: 62,
    baseDrought: 42,
  },
...
export default function VayuSetuDashboard() {
  ...
  const [chatHistory, setChatHistory] = useState([
    { role: "assistant", text: "Welcome to VAYUSETU AI Space Assistant. How can I help you analyze climate parameters for the Coastal Andhra Pradesh pilot region today?" }
  ]);
  ...
  useEffect(() => {
    ...
    // Center map on Coastal Andhra Pradesh
